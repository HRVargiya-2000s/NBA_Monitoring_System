...
const FacultyNavbar = () => {
  ...
  const getTabClass = ({ isActive }) => {
    return isActive
      ? 'font-semibold text-blue-800 border-b-2 border-blue-800 bg-blue-50 rounded-lg px-4 py-2 cursor-pointer transition-all'
      : 'font-semibold text-gray-600 hover:bg-gray-100 rounded-lg px-4 py-2 cursor-pointer transition-all';
  };
    ...
    <div className="navbar bg-white shadow-md px-4 py-2 border-b border-gray-200">
      ...
      <div className="navbar-center flex justify-center w-1/2">
        <ul className="flex space-x-2">
          <li>
            <NavLink to="/faculty" end className={getTabClass}>
              Dashboard
            </NavLink>
          </li>
          <li>
            <NavLink to="/faculty/co-po-view" className={getTabClass}>
              CO-PO View
            </NavLink>
          </li>
          <li>
            <NavLink to="/faculty/assessment" className={getTabClass}>
              Assessment
            </NavLink>
          </li>
          <li>
            <NavLink to="/faculty/subjects" className={getTabClass}>
              Subjects
            </NavLink>
          </li>
        </ul>
      ...
      <div className="navbar-end flex justify-end w-1/4 pr-2">
        <div className="dropdown dropdown-end">
          ...
          <label tabIndex={0} className="btn bg-white border border-gray-300 hover:bg-gray-50 flex items-center gap-2 rounded-lg px-4 py-2 min-h-0 h-auto cursor-pointer shadow-sm">
            ...
            <span className="font-semibold text-gray-700 normal-case text-sm">{facultyName}</span>
          ...
          <ul tabIndex={0} className="menu dropdown-content mt-3 p-2 shadow-lg bg-white border border-gray-200 rounded-lg w-44 z-50">
            <li>
              <NavLink to="/faculty/profile" className="text-blue-800 hover:bg-blue-50 font-medium flex items-center gap-3 py-2.5 cursor-pointer">
