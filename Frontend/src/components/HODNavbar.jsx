    ...
    <div className="navbar bg-white shadow-md px-4 py-2 border-b border-gray-200">
      ...
      <div className="navbar-center flex-1 justify-center px-2">
        <ul className="flex items-center gap-2 whitespace-nowrap">
          <li>
            <NavLink to="/hod" end className={getTabClass}>
              Dashboard
            </NavLink>
          </li>
          <li>
            <NavLink to="/hod/co-po-view" className={getTabClass}>
              CO-PO View
            </NavLink>
          </li>
          <li>
            <NavLink to="/hod/assessment" className={getTabClass}>
              Assessment
            </NavLink>
          </li>
          <li>
            <NavLink to="/hod/subjects" className={getTabClass}>
              Subjects
            </NavLink>
          </li>
          <li>
            <NavLink to="/hod/subject-assignment" className={getTabClass}>
              Assign Subjects
            </NavLink>
          </li>
            <li>
              <NavLink to="/hod/create-offering" className={getTabClass}>
                Create Offering
              </NavLink>
            </li>
        </ul>
      ...
      <div className="navbar-end flex justify-end w-1/4 pr-2">
        <div className="dropdown dropdown-end">
          ...
          <label tabIndex={0} className="btn bg-white border border-gray-300 hover:bg-gray-50 flex items-center gap-2 rounded-lg px-4 py-2 min-h-0 h-auto cursor-pointer shadow-sm">
            ...
            <span className="font-semibold text-gray-700 normal-case text-sm">HOD</span>
          ...
          <ul tabIndex={0} className="menu dropdown-content mt-3 p-2 shadow-lg bg-white border border-gray-200 rounded-lg w-44 z-50">
            <li>
              <NavLink to="/hod/profile" className="text-blue-800 hover:bg-blue-50 font-medium flex items-center gap-3 py-2.5 cursor-pointer">
